        ...
        <div class="w-full h-full bg-white shadow-lg rounded-lg p-6 flex flex-col gap-4">
            ...
            <div class="w-full flex justify-between flex-wrap gap-3">
                ...
                <div class="flex items-center gap-2 font-medium">
                    <a href="transactions.php" class="px-4 py-2 rounded-t-md border-b-2 border-green-600 bg-green-50 text-green-800">
                        Transactions Today
                    </a>
                    <a href="tr_history.php" class="px-4 py-2 rounded-t-md border-b-2 border-transparent hover:border-green-600 hover:bg-green-50 transition">
                        Transaction History
                    </a>
                </div>
                        ...
                        <?php
                            ...
                            if(mysqli_num_rows($run_query)>0){
                                while($row = mysqli_fetch_array($run_query)){
                                    ...
                                    $trTime = date("h:i A", strtotime($row['created_at']));
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="p-2 flex flex-wrap gap-2">
                                <a href="receipt.php?id=<?= $row['transId']?>">
                                    <button class="text-xs px-3 py-1 bg-yellow-600 hover:bg-yellow-700 text-white rounded-md transition">
                                        View
                                    </button>
                                </a>
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                ...
                <div class="col-span-2 md:col-span-1 flex flex-col justify-center">
                    <p class="text-sm text-gray-500">Total Sales Date</p>
                    <h2 class="text-lg font-semibold"><?= date("F j, Y"); ?></h2>
                </div>
