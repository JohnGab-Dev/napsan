...
<div class="w-full h-screen pt-10 flex px-4">
    <div class="w-[20%] h-full border-r py-10 flex flex-col gap-16">
        ...
        <div class="w-full h-5/5 flex flex-col font-medium">
            <a href="settings.php" class="w-full px-1 py-2 bg-white hover:bg-white">
                Change Password
            </a>
    ...
    <div class="w-[80%] h-full p-4 ">
        ...
        <form action="api/SettingsController.php" method="POST" class="w-full h-5/5 rounded-sm p-5 flex flex-col gap-4">
            ...
            <div class="">
                <h1 class="font-semibold text-sm">Change your password here</h1>
            ...
            <div class="">
                ...
                <input type="password" name="opass" id="opass" class="w-full border h-10 text-lg outline-none px-1 border-black rounded-sm focus:border-2 focus:border-green-600" autofocus>
            </div>
            <div class="">
                <label for="npass">Enter New Password</label>
                <input type="password" name="npass" id="npass" class="w-full border h-10 text-lg outline-none px-1 border-black rounded-sm focus:border-2 focus:border-green-600">
            </div>
            <div class="">
                <label for="cpass">Confirm New Password</label>
                <input type="password" name="cpass" id="cpass" class="w-full border h-10 text-lg outline-none px-1 border-black rounded-sm focus:border-2 focus:border-green-600">
            </div>

            <div class="">
                <button type="submit" name="changePass" class="w-full h-8 bg-green-600 text-white font-semibold hover:bg-green-700 active:opacity-80">Save Changes</button>
            </div>
