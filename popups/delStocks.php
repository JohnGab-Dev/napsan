<div class="bg1 delStockui w-full h-screen z-50 items-center justify-center absolute top-0">
    <form action="api/ProductController.php" method="POST" class="w-2/6 h-5/5 bg-white rounded-sm p-5 flex flex-col gap-4">
        ...
        <h1 class="text-2xl font-medium text-center">Are you sure you want to delete all stock deliveries?</h1>
        <div class="w-full flex justify-end items-center gap-4 mt-5">
            ...
            <button type="submit" name="delStockAll" class=" py-3 px-6 text-lg  bg-red-600 text-white font-semibold hover:bg-red-700 active:opacity-80 rounded-sm">Yes</button>
        </div>
...
<script>
     document.addEventListener("DOMContentLoaded", () => {
        const delDisp = document.querySelector(".delStockui");
