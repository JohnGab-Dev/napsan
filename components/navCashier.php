...
?>
<nav class="w-full h-16 bg-white flex items-center px-10 border-b justify-between fixed top-0 z-40">
    ...
    <div class="w-auto h-auto flex gap-1 items-center">
        <!-- Notification Toggle -->
        <div class="notiftoggle px-3 py-2 rounded-lg flex items-center cursor-pointer hover:bg-slate-100 active:bg-gray-200">
            <img src="imgs/notification.png" alt="" class="w-6 h-6">
            <p class="text-sm text-red-600 font-semibold"><?= $num == 0 ? '' : $num?></p>
        </div>
        
        <div class="user px-3 py-2 rounded-lg flex items-center gap-1 cursor-pointer hover:bg-slate-100 active:bg-gray-200">
