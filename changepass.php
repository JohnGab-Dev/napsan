...
<div class="bg w-full h-screen ">
    <div class="bg1 w-full h-full flex items-center justify-center">
        <form action="api/LoginController.php" method="post" class="w-2/6 h-5/5 bg-white rounded-sm p-5 flex flex-col gap-4 shadow-lg">
            ...
            <div class="">
                <h1 class="font-semibold text-sm">Reset your password</h1>
            ...
            <div class="">
                ...
                <input type="password" name="npass" id="npass" class="w-full border h-10 text-lg outline-none px-1 border-black rounded-sm focus:border-2 focus:border-green-600" autofocus>
            </div>
            <div class="">
            ...
            <div class="">
                <button type="submit" name="save" class="w-full h-8 bg-green-600 text-white font-semibold hover:bg-green-700 active:opacity-80">Save Changes</button>
            </div>
